...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm('service_jgtsixo', 'template_cjp1sj3', formRef.current, 'QXs6CH4XjdJSWBHrw' )
            .then(
            () => {
                setSuccess(true);
            },
...
return (
    <motion.div ref={ref} className="contact" variants={variants} initial="initial" whileInView="animate">
        ...
        <svg className="svg" fill="none"   width="150%" height="150%" viewBox="0 0 64 64" version="1.1">
        <motion.path 
        strokeWidth={0.2}
        initial={{pathLengtht:0}}
